...
以下 GIF 均来自真实模型输出；为便于阅读，仅省略了加载等待过程。四类 Query 走互斥路径：精确查条、语义检索、澄清和拒答。


| exact_lookup                   | semantic_search                          |
| ------------------------------ | ---------------------------------------- |
| ![精确查条：查询刑法第75条](assets/rag-exact-lookup.gif) | ![语义检索：查询民事法律行为有效条件](assets/rag-semantic-search.gif) |
| 以法律名称和条号直接定位《中华人民共和国刑法》第 75 条。 | 对自然语言问题召回《中华人民共和国民法典》第 143 条，并给出基于证据的摘要。 |



| clarify                     | refuse             |
| --------------------------- | ------------------ |
| ![澄清：犯罪量刑信息不足](assets/rag-clarify.gif) | ![拒答：非法律问题](assets/rag-refuse.gif) |
| 量刑缺少关键事实时，请求补充争议主体、具体行为和事实。 | 对不属于法律问答范围的问题明确拒答。 |
